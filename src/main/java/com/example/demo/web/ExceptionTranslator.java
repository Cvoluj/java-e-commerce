...
import static com.example.demo.util.ValidationDetailsUtils.getValidationErrorsProblemDetail;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(FailedProcessActivation.class)
    public ResponseEntity<ProblemDetail> handleFailedProcessActivationException(FailedProcessActivation ex) {
        log.error("FailedProcessActivation: {}", ex.getMessage());
        ProblemDetail problemDetail = forStatusAndDetail(BAD_REQUEST, ex.getMessage());
        problemDetail.setType(URI.create("failed-process-activation"));
        problemDetail.setTitle("Failed Process Activation");
